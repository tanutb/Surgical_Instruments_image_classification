...
def main():
    ...
    # Dataset for testing
    ##################################
    test_dataset = get_trainval_datasets2(config.tag, resize=config.image_size)
    ...
    with torch.no_grad():
        ...
        f = open("C:\\Users\\gmita\\Desktop\\work_3_2_2565\onboard\\WS-DAN.PyTorch-master\\c\\ypred.txt","w")
        for i in y_pred_list:
            f.write(str(int(i.numpy())))
        f.close()

        f = open("C:\\Users\\gmita\\Desktop\\work_3_2_2565\onboard\\WS-DAN.PyTorch-master\\c\\ytrue.txt","w")
        ...
        report = classification_report(y_true_list, y_pred_list, target_names=Class_name)
        print(report)
